...
"""
Supplementary figure: Numerov validation of the continuum-certified
negative-energy spectrum.

The corrected FDM and Numerov results agree at the 0.02-0.03 Hz level.
Because the two spectra are visually indistinguishable on an MHz energy
axis, the final figure displays the signed level-resolved differences in Hz
and lists the two energy sets in a compact external annotation.

Outputs
-------
1) numerov_verification_negative_spectrum.csv
2) numerov_verification_negative_spectrum.pdf
3) numerov_verification_negative_spectrum.png
4) numerov_verification_negative_spectrum.svg
"""
